...
namespace Orchestration.CompareIrps
{
	public class CompareIrpsOrchestrator
	{
		...
		private List<CompareIrpsAthleteInfoDto> GetCompareIrpsAthleteInfoDtos(List<AthleteCourse> athleteCourses, int primaryBracketId, Course course)
		{
		...
		private CompareIrpsAthleteInfoDto MapToCompareIrpsAthleteInfoDto(AthleteCourse athleteCourse, int index, Course course, int primaryBracketId)
		{
