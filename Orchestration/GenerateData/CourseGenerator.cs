...
namespace Orchestration.GenerateData
{
	public static class CourseGenerator
	{
		...
		private static Course GetCourse(Course oo, int index, Race race)
		{
			...
			var descriptionEntries = new[]
			{
				new CourseInformationEntry { CourseInformationType = CourseInformationType.Description, Description = "The most difficult course of the series." },
				new CourseInformationEntry { CourseInformationType = CourseInformationType.Description, Description = "This course is a great intro to the sport." },
				new CourseInformationEntry { CourseInformationType = CourseInformationType.Description, Description = "This is an intermediate level course." },
			};

			var motivationalEntries = new[]
			{
				new CourseInformationEntry { CourseInformationType = CourseInformationType.Promotional, Description = "Train up for this event and come see us." },
				new CourseInformationEntry { CourseInformationType = CourseInformationType.Promotional, Description = "Help race for a cause." },
				new CourseInformationEntry { CourseInformationType = CourseInformationType.Promotional, Description = "Train up for this event and come see us." },
			};
