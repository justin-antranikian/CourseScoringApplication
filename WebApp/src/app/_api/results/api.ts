...
import { ResultCompareAthleteInfoDto, Irp, IrpSearchRequest, IrpSearchResult } from "./definitions"
...
export default (apiFetch: ApiFetch) => ({
  ...
  compare: async (athleteCourseIds: string[]): Promise<ResultCompareAthleteInfoDto[]> => {
