...
public static class GeometryExtensions
{
    ...
    public static Geometry GetRandomGeometry()
    {
        ...
        var wktReader = GetReader();
        return wktReader.Read(states.GetRandomValue());
    }

    private static WKTReader GetReader()
    {
