...
export default function CardContainer({
  ...
  const [irpDetails2, setIrpDetails2] = useState<Irp | null>(null)
  ...
  //                         <span className="ml-2" onClick={() => handlePopoverChange(true, irp)}>
  //                           Baa
  //                           {/* <Popover
  //                             onOpenChange={(open) =>
